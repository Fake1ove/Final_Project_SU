...
uint8_t receiverMac2[] = {0x84, 0x0d, 0x8e, 0x97, 0xa0, 0xe3}; // esp01_Relay 
// uint8_t receiverMac3[] = {0x5c, 0xcf, 0x7f, 0x06, 0xf4, 0xc2}; // *********
// uint8_t receiverMac4[] = {0x5c, 0xcf, 0x7f, 0x06, 0xf4, 0xc2}; // *********
// uint8_t receiverMac5[] = {0x5c, 0xcf, 0x7f, 0x06, 0xf4, 0xc2}; // *********
...
void OnDataRecv(uint8_t *mac, uint8_t *incomingData, uint8_t len) {
   if (len == sizeof(struct_message)) { 
    ...
    } else if (strcmp(receivedCommand, "S1_ON") == 0) {
